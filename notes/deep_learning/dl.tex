...
\includegraphics[width=0.5\columnwidth]{lecture_06/sigmoid.png}
tanh - $tanh(x)$ 
...
\includegraphics[width=0.5\columnwidth]{"lecture_06/Screenshot 2019-10-18 at 13.31.23.png"}
...
\subsubsection{Approaches to Initializing the NN:}
 ...
 - Set initial weights to a small value that we sample from a normalized (Gaussian) with 0 mean W = 0.01*np.random.randn()
   	...
   	- This works for small networks but does not work for deeper network
      	...
      	\includegraphics[width=0.5\columnwidth]{lecture_06/ecture_06_normalized-activation.png}
 ...
 - But this breaks when you use a ReLU
   ...
   - changes the variance - so you can divide by 2 and this improves the weights
    ...
    \includegraphics[width=0.5\columnwidth]{lecture_06/xavier_init_vis.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_07/adam_params.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_07/learning_rate_decay.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_07/first_order_approx.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_07/second_order_approx.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_07/Screenshot 2019-10-21 at 11.32.00.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_07/guidelines_transfer_learning.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_08/Screenshot 2019-10-21 at 12.32.42.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_08/Screenshot 2019-10-21 at 12.45.00.png}

So in this version the weights update step needs to live within the computational graph, so the final version is this? 

\includegraphics[width=0.5\columnwidth]{lecture_08/tf_in_memory.png}

so we have to add a dummy node which is responsible for updating the weights:

\includegraphics[width=0.5\columnwidth]{lecture_08/tf_memory_updates.png}

and tell tf to update the node.

This is a bit ugly, we can simple use an TF optimizer: 

\includegraphics[width=0.5\columnwidth]{lecture_08/optimizer.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_08/pytorch_tensors.png}

\paragraph{Variables + autograd}

\includegraphics[width=0.5\columnwidth]{lecture_08/pytoch_variable.png}

- PyTorch we build a new graph at every forward pass which makes the code a bit cleaner
- Define autograd functions by writing forward and backwards func. imp. for Tensors\includegraphics[width=0.5\columnwidth]{lecture_08/pytorch_autograd.png}
- we also work at the higher level:
- \includegraphics[width=0.5\columnwidth]{lecture_08/pytorch_nn.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_08/complete_pytorch_pipeline.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_08/what_to_use.png}

\section{CNN Architectures}
\subsection{AlexNet}

\includegraphics[width=0.25\columnwidth]{lecture_09/alex_net_2.png}

\includegraphics[width=0.5\columnwidth]{lecture_09/alex_net.png}

\subsection{Introduction of Deeper Networks}
\includegraphics[width=0.5\columnwidth]{lecture_09/deeper_networks.png}

\subsection{GoogleNet}

- only 5 million params, x12 less than alexnet

\includegraphics[width=0.5\columnwidth]{lecture_09/google_net.png}

\textbf{Inception Module}

Design a good local network topology (network within a network) and stack them together:

\includegraphics[width=0.5\columnwidth]{lecture_09/naive.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_09/less_naive.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_09/deep_error.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_09/complexity.png}
...
% \includegraphics[width=0.15\columnwidth]{lecture_10/data_flows.png}
...
% \includegraphics[width=0.5\columnwidth]{lecture_10/rnn.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_10/rnn_formulation.png}

RNN Unrolling: W remains constant throughout the optimization

\includegraphics[width=0.5\columnwidth]{lecture_10/rnn_unrolling.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_10/image_captioning_with_attention.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_10/back_prop_rnn.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_10/backprop_multi_layer.png}

\includegraphics[width=0.5\columnwidth]{lecture_10/gradients.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_10/lstm.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_10/lstm_arch.png}

$\Rightarrow$ also check out Highway Networks ICML Srivasta

\subsection{Segmentation with CNNs}

\includegraphics[width=0.5\columnwidth]{lecture_11/semantic_segmentation.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_11/patch_based.png}

\paragraph{Approach \#2 - Fully convolutional}

Design a network as a bunch of conv layers

\includegraphics[width=0.5\columnwidth]{lecture_11/fully_convolutional.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_11/down_up_sampling.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_11/nn_uppooling.png}

Bed of nails:

\includegraphics[width=0.5\columnwidth]{lecture_11/bed_of_nails.png}

Max Unpooling:

\includegraphics[width=0.5\columnwidth]{lecture_11/max_unpooling.png}

\subsubsection{Learnable Upsampling - Transpose Convolution }

\includegraphics[width=0.5\columnwidth]{lecture_11/learnable_conv.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_11/trans_conv_math.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_11/class_loc.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_11/fast-rcnn.png}

During training add a multi class loss to do regression and do back prop:

\includegraphics[width=0.5\columnwidth]{lecture_11/fast_rcnn_2.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_11/YOLO_SSD.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_12/first_layer_vis.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_12/patches.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_12/text_synthesis.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_12/texture_synthesis.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_12/style_transfer.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_13/density.png}
...
- Learning latent variable representation
  ...
  \includegraphics[width=0.5\columnwidth]{lecture_13/taxonomy.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_13/encoder_decoder.png}

After this step, we don't need to decoder anymore - we can use this to initialize a supervised model:

\includegraphics[width=0.5\columnwidth]{lecture_13/supervised_encoder.png}
...
Now sample from true conditional: $p_{\theta^\star}(x|z^i)$ \includegraphics[width=0.5\columnwidth]{lecture_13/decoder_training.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_13/encoder_theta.png}

and similarly we have a probabilistic decoder network:

\includegraphics[width=0.5\columnwidth]{lecture_13/prob_decoder.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_13/gans_1.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_13/gan_pipeline.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_13/gan_loss.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_13/gan_fixed_loss.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_13/full_opt_pipeline.png}
...
\includegraphics[width=0.5\columnwidth]{lecture_13/interpetable.png}

Radford et al. ICLR 2016

\includegraphics[width=0.5\columnwidth]{lecture_13/year_of_gan.png}
...
\includegraphics[width=0.5\columnwidth]{"lecture_16/Screenshot 2019-10-25 at 16.16.26.png"}
...
\includegraphics[width=0.5\columnwidth]{lecture_16/Screenshot 2019-10-25 at 16.18.19.png}
